...
from analytical_solutions import elasticity_exact_2d
...
def main(mesh_size):
    ...
    mu_s, lambda_s = 0.5, 1
    sigma_ex, w_ex, u_ex, r_ex, f_s, f_u, _ = elasticity_exact_2d(mu_s, lambda_s)
    ...
    r_bc = eps * bdm1.assemble_nat_bc(sd, r_ex, bd_faces)
    ...
    err_w = bdm1.error_l2(sd, w, w_ex, data=data, relative=False)
